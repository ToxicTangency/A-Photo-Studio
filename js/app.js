 ...
 */
    ...
    (() => {
        ...
        $(document).ready((function() {
            let burgerMenu = $(".burger-menu"), burgerItems = burgerMenu.find(".burger-menu_button", ".burger-menu_lines"), burgerLink = burgerMenu.find(".burger-menu_link"), burgerOverlay = burgerMenu.find(".burger-menu_overlay");
            function toggleMenu() {
                burgerMenu.toggleClass("burger-menu_active"), burgerMenu.hasClass("burger-menu_active") ? $("body").css("overflow", "hidden") : $("body").css("overflow", "visible");
            }
            burgerItems.on("click", (e => {
                e.preventDefault(), toggleMenu();
            })), burgerLink.on("click", (() => toggleMenu())), burgerOverlay.on("click", (() => toggleMenu()));
        }));
        class Popup {
            constructor(options) {
                let config = {
...
***************************************************************************** */
        ...
        let heroCards = document.getElementsByClassName("hero-card");
        let actCard = document.getElementsByClassName("active-hero");
        Array.from(heroCards).forEach((heroCard => {
            heroCard.onclick = function() {
                actCard[0].classList.remove("active-hero");
                heroCard.classList.add("active-hero");
            };
            console.log(heroCards.length);
        }));
        console.log(heroCards.length);
        window["FLS"] = true;
        isWebp();
